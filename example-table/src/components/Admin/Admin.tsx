...
const Admin: React.FC = () => {
  ...
  return (
    <div
      className="flex flex-col space-y-6 font-sans w-full"
      style={{ fontFamily: 'Satoshi, sans-serif' }} // Apply Satoshi globally
    >
      {/* Cards Row */}
      ...
      <div className="bg-white shadow-lg rounded-lg p-4 flex-1 text-center">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 mx-auto mb-2 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<div className="bg-white shadow-lg rounded-lg p-4 flex-1 text-center">
  <svg
    ...
    viewBox="0 0 24 24"
    stroke="currentColor"
    className="w-10 h-10 mx-auto mb-2 text-blue-600"
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
      d="M19 3H5c-1.104 0-2 .896-2 2v14c0 1.104.896 2 2 2h14c1.104 0 2-.896 2-2V5c0-1.104-.896-2-2-2zM7 3v4M17 3v4"
    />
  </svg>
        ...
        <table className="w-full text-sm text-gray-700">
          <thead className="bg-gray-200 text-base text-gray-800 border-gray-200">
            <tr>
              ...
              <th className="py-3 px-2 text-center border-b border-gray-400">NAMA</th>
